...
Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://fmxtoolsstarterkit.developpeur-pascal.fr/) or [the project devlog](https://developpeur-pascal.fr/fmt-tools-starter-kit.html).
